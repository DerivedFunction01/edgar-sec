...
defs/
  ...
  tables/               # geometry-first ASCII table renderer, span extraction, cell tokens, tagged-table protection, table boundary policy, and structural detection
